    ...
    public partial class AnaDepoListForm : BaseListForm
    {
        ...
        protected override void Listele()
        {
            ...
            if (AktifKartlariGoster)
            {
                ...
                DataSet ds = komutlar.Dataset("Select * from VW_SayimListesiYer where DONEM_ID ='" + AnaForm._donemId + "'and YER_ID='" + AnaForm._birimId + "'", baglan.bgl());
                var lst = ds.Tables[0];
                grid.DataSource = lst;
                baglan.bgl(false);
            }
