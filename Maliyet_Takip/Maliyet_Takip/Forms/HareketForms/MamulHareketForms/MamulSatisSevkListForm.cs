...
{
    public partial class MamulSatisSevkListForm : BaseListForm
    {
        ...
        protected override void Listele()
        {
            ...
            if (AktifKartlariGoster)
            {
                ...
                DataSet ds = komutlar.Dataset("Select * from VW_EVRAKLAR where GCKodu='Satis' and DonemId='" + AnaForm._donemId + "'", baglan.bgl());
                var lst = ds.Tables[0];
                grid.DataSource = lst;
                baglan.bgl(false);
            }
        ...
        protected override void Duzelt()
        {
            if (Tablo.FocusedRowHandle > -1)
            {
                ...
                formlar.MamulSatisEditFormu(SeciliGelecekId, true);
            }
        }
