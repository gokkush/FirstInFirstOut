...
{
    public partial class MamulSevkEditForm : BaseEditForm
    {
        ...
        public MamulSevkEditForm(int id, bool ac)
        {
            _ac = ac;
            _id = id;
            InitializeComponent();
                        ...
                        if (dr == System.Windows.Forms.DialogResult.Yes)
                        {
                            try
                            {
                                if (!_ac)
                                {
                                    ...
                                    komut.Parameters.AddWithValue("@EvrakTuru", "Mamül Sevk");
                                    ...
                                    komut.Parameters.AddWithValue("@GCKodu", "MamulSevk");
            ...
            else
            {
                try
                {
                    ...
                    if (sender == txtStok)
                    {
                        ...
                        komut = new SqlCommand("Select * from VW_MamulSayimListesiYer where Id = '" + txtStok.Id + "' and YER_ID= '" + AnaForm._birimId + "'", baglan.bgl());
                        oku = komut.ExecuteReader();
                        while (oku.Read())
                        {
        ...
        private void btnStokSec_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            if (id > 0 && var == false)
            {
                ...
                komut = new SqlCommand("Select * from Mamuller where Id = '" + id + "'", baglan.bgl());
                oku = komut.ExecuteReader();
                while (oku.Read())
                {
            ...
            {
                mesajlar.Hata("Daha önce bu Mamül eklenmiş");
            }
