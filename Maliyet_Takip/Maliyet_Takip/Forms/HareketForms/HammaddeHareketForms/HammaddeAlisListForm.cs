...
{
    public partial class HammaddeAlisListForm : BaseListForm
    {
        ...
        protected override void Listele()
        {
            ...
            if (AktifKartlariGoster)
            {
                ...
                DataSet ds = komutlar.Dataset("Select * from VW_EVRAKLAR where GCKodu='Alis' and DonemId='"+AnaForm._donemId+"'", baglan.bgl());
                var lst = ds.Tables[0];
                grid.DataSource = lst;
                baglan.bgl(false);
            }
        ...
        protected override void Duzelt()
        {
            if (Tablo.FocusedRowHandle > -1)
            {
                ...
                formlar.HammaddeAlisEditFormu(SeciliGelecekId, true);
            }
        }
